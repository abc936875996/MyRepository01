...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "Y0XRZsTSYGEcg1_-xbu2mrqhSUVWaMX50xVG5xl_";
    private static final String SECRETKEY = "0qIRzTmY_IN2-5x4FeffjZfoqnjxj-SDhmA14muw";
    private static final String BUCKET = "health-tencent";
    public static final String DOMAIN= "http://qmlhlpv9t.hn-bkt.clouddn.com/";
